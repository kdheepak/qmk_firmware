...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_GESC,        KC_A,           KC_S,           KC_D,           KC_F,           KC_G,           KC_SLSH,                                        KC_BSLS,      KC_H,           KC_J,           KC_K,           KC_L,           KC_SCOLON,      KC_QUOTE,
    KC_LSFT,        KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                                                         KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_TRANSPARENT, KC_SFTENT,
    KC_LCTL,        KC_LALT,        KC_HYPR,        KC_LALT,        KC_LGUI,        _______,                                                                      _______,        KC_RALT,        KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,
  ...
  [1] = LAYOUT_moonlander(
    ...
    KC_GRAVE,       KC_HASH,        KC_DLR,         KC_LPRN,        KC_RPRN,        KC_GRAVE,       KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_DOWN,        KC_4,           KC_5,           KC_6,           KC_KP_PLUS,     KC_TRANSPARENT,
