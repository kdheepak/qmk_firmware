...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_LCTL, KC_LALT, KC_HYPR, MO(1),   KC_LGUI,          _______,                    _______,          KC_RALT,  MO(2),   KC_LEFT, KC_DOWN, KC_RIGHT,
                                                  KC_SPC, TT(1),   TT(3),    TT(4),   TT(2),   KC_SPC
  ),
  [1] = LAYOUT_moonlander(
    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_VOLD,                    KC_VOLU, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,
    _______, KC_BTN1, KC_MS_U, KC_BTN2, KC_ACL0, _______, KC_WH_L,                    KC_WH_R, _______, _______, _______, _______, _______, _______,
  ...
  [3] = LAYOUT_moonlander(
    _______, _______, _______, _______, _______, _______, _______,                    _______, _______, _______, _______, _______, _______, _______,
    _______, DM_REC1, _______, _______, _______, _______, _______,                    _______, _______, _______, _______, _______, DM_PLY1, _______,
    _______, _______, _______, _______, _______, _______, _______,                    _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______,                                      _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______,          _______,                    _______,          _______, _______, _______, _______, _______,
                                                 _______, _______, _______,  _______, _______, _______
