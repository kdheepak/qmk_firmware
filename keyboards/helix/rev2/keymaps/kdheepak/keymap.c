...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   KC_SLSH, KC_BSLS, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP,   KC_SFTENT, \
  ...
  [_LOWER] = LAYOUT( \
      ...
      KC_TILD, _______, _______, _______, _______, _______,                   _______, _______, KC_QUES, KC_PIPE, KC_SLSH, KC_BSLS, \
      KC_GRV,  _______, _______, _______, _______, _______,                   KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, KC_COLN, KC_DQUO, \
      _______, _______, _______, _______, _______, _______, KC_QUES, KC_PIPE, _______, _______, KC_LABK, KC_RABK, _______, _______, \
  ...
  [_ADJUST] =  LAYOUT( \
      ...
      _______, _______, _______, _______, _______, _______, KC_LCBR, KC_RCBR, _______, _______, _______, _______, RGB_MOD, _______, \
