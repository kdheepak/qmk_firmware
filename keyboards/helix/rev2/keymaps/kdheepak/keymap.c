...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_LCTL,  KC_LALT, KC_HYPR, KC_LGUI, KC_SPC,  LOWER,  KC_LBRC, KC_RBRC, RAISE,   KC_SPC,  KC_RALT,   KC_LEFT, KC_DOWN, KC_RIGHT \
      ),

  [_LOWER] = LAYOUT( \
      _______,  _______, _______, _______, _______, _______,                   _______, _______, _______, _______,  _______,  _______, \
      _______,  _______, _______, _______, _______, _______,                   _______, _______, _______, _______,  _______,  _______, \
      KC_GRAVE, _______, _______, _______, _______, _______,                   KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, _______,  _______, \
  ...
  [_RAISE] = LAYOUT( \
      ...
      KC_TILD, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______,                   _______, KC_KP_4,     KC_KP_5, KC_KP_6,   KC_KP_ASTERISK, _______, \
